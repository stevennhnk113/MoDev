...
namespace PersonalApp
{
	...
	public class UnitTest
	{
		...
		{
			Item testItem = new Item() { Strength = 1, Health = 2, Speed = 3, Defense = 4 };
			dataAccess = new ItemsDataAccess(true);
		...
		{
			dataAccess = new ItemsDataAccess(true);
			dataAccess.SaveItem(new Item() { Strength = 3, Health = 4, Speed = 10, Defense = 6 });
			testAddItemPage = new AddItemPage(dataAccess);
		...
		{
			Item testItem = new Item() { Strength = 3, Health = 4, Speed = 10, Defense = 6};
			dataAccess = new ItemsDataAccess(true);
			dataAccess.SaveItem(testItem);
